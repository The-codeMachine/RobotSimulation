...
public:
    ...
    ViewSensor(const std::string& id, double fov, double range,
        Transform localTransform, const std::string& type = "ViewSensor");
    ViewSensor(const std::string& id, std::unique_ptr<SensorShape> shape,
        Transform localTransform, const std::string& type = "ViewSensor");
